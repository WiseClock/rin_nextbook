    ...
    return (
      <div className='pr-2'>
        ...
        <Scrollspy
          ...
          itemContainerClassName='tracking-wide mt-4 text-gray-600 dark:text-gray-400 text-sm 2xl:text-base border-0 border-l border-gray-300 dark:border-gray-600 leading-6 cursor-pointer max-h-96'
